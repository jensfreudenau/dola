<nav class="navbar navbar-light" style="background-color: #243a51;">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown links">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="/records/record">Kreisrekorde</a></li>
                            <li class="divider"></li>
                    ...
                    <li class="dropdown links">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="/pages/vereine">Vereine</a></li>
                            <li><a href="/pages/adressen_kla">KLA Dortmund</a></li>
